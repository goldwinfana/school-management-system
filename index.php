...
<body class="is-boxed">
    <div class="body-wrap ">
        ...
        <main>
            <section class="hero" style="padding-top: 150px;margin-right: 200px">
                <div class="container" >
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0 is-revealing">Welcome to Tshwane Secondary School</h1>
	                        <p class="hero-paragraph is-revealing">Our system is a one stop to learning, find out more by clicking on the register button on to.
                                Our grades starts from Grade 8 to Grade 12.</p>
							<div class="hero-form field field-grouped is-revealing" hidden>
            ...
            <section class="features section" style="margin-right: 200px">
                <div class="container">
	                        ...
	                        <div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Discovery</h4>
									</div>
							...
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Registration Costs</h4>
									</div>
	                                <p class="text-sm mb-2">
                                        * Registration fee - R1 500(proof of pay to be uploaded on registration)<br>
                                        * Annual school fee - R60 000
                                    </p>
	                            </div>
	                        </div>
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Contact Us</h4>
									</div>

                                    <p class="text-sm mb-0">
                                        <i class="fa fa-envelope"></i> schoolms2022@gmail.com
                                    </p>
                                    <p class="text-sm mb-0">
                                        <i class="fa fa-phone"></i> (+27)11 256 1234
                                    </p>
                                    <p class="text-sm mb-0">
                                        <i class="fa fa-location-arrow"></i> Soshanguve Block M, <br>
                                        Aubrey Matlala Street, 0001
                                    </p>
	                            </div>
	                        </div>
						</div>
